  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active" style="font-size: 18px;">Product List</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box" style="background: #e2d5cd; border: 1px solid #332F2B;
border-radius: 11px;">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered" style="text-align: center; vertical-align: middle;">
                <thead>
                  <th>Name</th>
                  <th>Photo</th>
                  <th>Description</th>
