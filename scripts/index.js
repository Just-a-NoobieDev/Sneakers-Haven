...
// login.php
function login() {
  request("controllers/login.php", "#loginForm", function (data) {
    ...
    switch (data) {
      ...
      case "3":
        document.getElementById("errs").innerHTML +=
          '<div class="err">You have exceeded the max number of login attempts per hour. Try again in an hour.</div>';
        break;
      case "4":
        document.getElementById("errs").innerHTML +=
          '<div class="err">Your email has not been validated. Please check your email for a validation link or <a href="./validate">click here</a> to send another link</div>';
        break;
      default:
        document.getElementById("errs").innerHTML +=
...
// register.php
function register() {
  request("controllers/register.php", "#registerForm", function (data) {
    document.getElementById("errs").innerHTML = "";
    var transition = document.getElementById("errs").style.transition;
    document.getElementById("errs").style.transition = "none";
    document.getElementById("errs").style.opacity = 0;
    ...
    try {
      ...
      for (var i = 0; i < data.length; ++i) {
        switch (data[i]) {
          case 0:
            document.getElementById("errs").innerHTML +=
              "<div>Your account has been created!</div><div>Please validate your email by checking your inbox for a validation link before logging in.</div>";
            document.getElementById("registerForm").reset();
            break;
          case 1:
            document.getElementById("errs").innerHTML +=
              '<div class="err">Invalid name entered. (only use letters, spaces, and hyphens)</div>';
            break;
          case 2:
            document.getElementById("errs").innerHTML +=
          ...
          case 3:
            document.getElementById("errs").innerHTML +=
              '<div class="err">Email does not exist. (This domain does not have a mail server)</div>';
            break;
          case 4:
            document.getElementById("errs").innerHTML +=
          ...
          case 6:
            document.getElementById("errs").innerHTML +=
              '<div class="err">Failed to add account to database. Please try again later.</div>';
            break;
          case 7:
            document.getElementById("errs").innerHTML +=
          ...
          case 10:
            document.getElementById("errs").innerHTML +=
              '<div class="err">Failed to send email. Please try again later.</div>';
            break;
          case 11:
            document.getElementById("errs").innerHTML +=
              '<div class="err">Failed to insert request into database. Please try again later.</div>';
            break;
          case 12:
            document.getElementById("errs").innerHTML +=
              '<div class="err">You have exceeded your number of allowed validation requests per day</div>';
            break;
          case 13:
            document.getElementById("errs").innerHTML +=
              '<div class="err">The user with this email is already validated</div>';
            break;
          case 14:
            document.getElementById("errs").innerHTML +=
              '<div class="err">A user with this email does not exist</div>';
            break;
          case 15:
            document.getElementById("errs").innerHTML +=
              '<div class="err">Failed to connect to database. Please try again later.</div>';
